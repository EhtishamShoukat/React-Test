...
function Main() {
  const [students, setStudents] = useState(() => {
    ...
    const cookieStudents = Cookies.get("students");
    return cookieStudents ? JSON.parse(cookieStudents) : [];
  });
  ...
  useEffect(() => {
    ...
    Cookies.set("students", JSON.stringify(students), { expires: 7 }); // Store in cookies for 7 days
  }, [students]);
